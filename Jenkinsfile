...
<p>Check console output at "<a href="${env.BUILD_URL}" + input>${env.JOB_NAME} [${env.BUILD_NUMBER}]</a>"</p>""", subject: "Job \'${env.JOB_NAME} [${env.BUILD_NUMBER}]\'", to: 'nishant.sharma@melbourneit.com.au'
            }
        }

pipeline {
    ...
    <p>Check console output at "<a href="${env.BUILD_URL}">${env.JOB_NAME} [${env.BUILD_NUMBER}]</a>"</p>"""''', subject: '"${buildStatus}: Job \'${env.JOB_NAME} [${env.BUILD_NUMBER}]\'"', to: 'nishant.sharma@melbourneit.com.au'
            }
        }
